...
<div class="login-box">
      <div class="card card-outline card-primary">
        ...
        <div class="card-body login-card-body col-12">
          ...
          <form action="<?php echo base_url();?>login/usr_login" method="POST">
            <div class="input-group mb-1">
              <div class="form-floating">
                <input id="loginEmail" name="loginEmail" type="email" class="form-control" value="" placeholder="" />
            ...
            <!--begin::Row-->
            <div class="row">
                <input type='text' id='lang' name='lang' value='thailand' hidden=hidden>
                              <!-- /.col -->
              <div class="col-12">
