        ...
        <?php if($_SESSION['f_user_login'] == 'suvat.k@naracuisine.com' || $_SESSION['f_user_login'] == 'pakpoom@naracuisine.com' || $_SESSION['f_user_login'] == 'napatsakorn@naracuisine.com'){ ?>
            ...
            >
        	 ...
        	 <!-- System Menu -->
              <li class="nav-item menu-open">
               ...
               <?php if(in_array(9,$_SESSION['sidebarPermittion'])){ ?>
               <li class="nav-item">
                    <a href="#" class="nav-link">
                      <i class="nav-icon bi bi-circle-fill"></i>
                      <p>
                    ...
                    <ul class="nav nav-treeview" style="display: none; box-sizing: border-box;">
                      <li class="nav-item">
                       ...
                       <!--<li class="nav-item">
                        <a href="#" class="nav-link ">
                          <i class="nav-icon bi bi-arrow-return-right"></i>
                          <p><?php echo $this->lang->line('subsidemenu42');?></p>
                        </a>
                        <ul class="nav nav-treeview" style="display: none; box-sizing: border-box;">
                          <li class="nav-item">
