        ...
        <div class="app-content">
          ...
          <div class="container-fluid">
            ...
            <div class="row">
                    ...
                    <!-- USERS LIST --><?php $t = 0; ?>
                     <?php foreach($branchData as $row1=>$value1){ ?>
                    <div class="card">
                      <div class="card-header">
                        <h3 class="card-title"><?php echo $value1->f_branch_name_th; ?></h3>
                      ...
                      <div class="card-body p-0">
                        <div class="row text-center m-1">
                         <?php foreach($empData[$t] as $rows3=>$value3){ ?>
                          <div class="col-3 p-2">
                           <img  src="<?php echo $value3->f_image;?>" alt="User Image"
                    ...
                    style="vertical-align: middle;">
                     ...
                     echo $value3->f_name_en ;
                         ...
                         echo $value3->f_name_th;
                        }?>
                            </a>
                            <div class="fs-8"><?php echo $value3->f_position; ?></div>
                          </div>
                          <?php } ?>
                        </div>
                        <!-- /.users-list -->
