...
<div class="app-wrapper">
   ...
   <main class="app-main">
      <div class="card mb-16">
                  ...
                  <form action="<?php echo base_url();?>qsr/checkdata" enctype="multipart/form-data" method="POST">
                  <!-- /.card-header -->
              <div class="row">
                    ...
                    <table class="table table-striped">
                      ...
                      $i++;
                        ...
                        <tr class="align-middle">
                          ...
                          <td></td>
                          <td></td>
                          <td> <input type='text' id='f_qsc_sum' name='f_qsc_sum' value='' hidden='hidden'>
                         <input type='text' id='f_qsc_total' name='f_qsc_total' value='' hidden='hidden'>
                         <input type='text' id='f_qsc_percentage' name='f_qsc_percentage' value='' hidden='hidden'></td>
                          <td>
                    ...
                    <table class="table table-striped">
                      ...
                      <tbody>
                        ...
                        <tr class="align-middle">
                          <td><?php echo $u ?>.</td>
                          <td><?php if ($_SESSION['slang'] == 'english'){ echo $rows->f_topic_detail_en;} else {echo $rows->f_topic_detail_th;}?></td>
                          <td><p type='textarea' id='<?php echo "pass9$u"; ?>' name='<?php echo "pass9$u"; ?>'></p></td>
                          <td>
                      ...
                      <tr class="align-right">
                        ...
                        <tr class="align-middle">
                          <td></td>
                          <td></td>
                          <td><button type="submit" class="btn btn-primary" id="myBtn2"><?php echo $this->lang->line('submit');?></button></td>
                          <td>
